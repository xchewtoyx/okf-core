...
2026-08-28 | #231 | 1 | path-escape | validate_graph_report_output_dir only rejects output_dir equal-to/inside a bundle; --output at a bundle parent (e.g. project root when bundle_root="docs") writes GRAPH_REPORT.md/graph.json into the bundle
